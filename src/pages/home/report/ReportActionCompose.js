...
class ReportActionCompose extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      conciergePlaceholderRandomIndex: _.random(
        this.props.translate('reportActionCompose.conciergePlaceholderOptions')
  ...
  getMoneyRequestOptions(reportParticipants) {
    const options = {
      [CONST.IOU.MONEY_REQUEST_TYPE.SPLIT]: {
        ...
        onSelected: () =>
          Navigation.navigate(ROUTES.getIouSplitRoute(this.props.reportID)),
      },
      [CONST.IOU.MONEY_REQUEST_TYPE.REQUEST]: {
        icon: Expensicons.MoneyCircle,
        text: this.props.translate('iou.requestMoney'),
        onSelected: () =>
          Navigation.navigate(ROUTES.getIouRequestRoute(this.props.reportID)),
      },
      [CONST.IOU.MONEY_REQUEST_TYPE.SEND]: {
        icon: Expensicons.Send,
        text: this.props.translate('iou.sendMoney'),
        onSelected: () =>
          Navigation.navigate(ROUTES.getIOUSendRoute(this.props.reportID)),
      },
    };
    return _.map(
      ReportUtils.getMoneyRequestOptions(
        this.props.report,
        reportParticipants,
        this.props.betas,
      ),
  ...
  triggerHotkeyActions(e) {
    ...
    if (
      ...
      const lastReportAction = _.find(this.props.reportActions, (action) =>
        ReportUtils.canEditReportAction(action),
      );
  ...
  prepareCommentAndResetComposer() {
    ...
    if (
      this.state.isCommentEmpty ||
      ReportUtils.getCommentLength(trimmedComment) > CONST.MAX_COMMENT_LENGTH
    ) {
      return '';
    }
    ...
    return (
      <View
                    ...
                    <>
                      <View
                        style={[
                          styles.dFlex,
                          styles.flexColumn,
                          this.state.isFullComposerAvailable ||
                          this.props.isComposerFullSize
            ...
            <Tooltip text={this.props.translate('common.send')}>
              <TouchableOpacity
                style={[
                  ...
                  this.state.isCommentEmpty || hasExceededMaxCommentLength
                    ? undefined
        ...
        <View
          ...
          {!this.props.isSmallScreenWidth && (
            <OfflineIndicator
              containerStyles={[styles.chatItemComposeSecondaryRow]}
            />
          )}
...
export default compose(
  ...
  withOnyx({
    ...
    numberOfLines: {
      key: ({reportID}) =>
        `${ONYXKEYS.COLLECTION.REPORT_DRAFT_COMMENT_NUMBER_OF_LINES}${reportID}`,
    },
    modal: {
      key: ONYXKEYS.MODAL,
    },
